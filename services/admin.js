		...
		mysql
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									// console.log("UnVerified Customers Found
									// !! " + JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("UnVerified Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("rejectCustomer Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("approveAllCustomer Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("rejectAllCustomer Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
		...
		mysql
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									// console.log("UnVerified Drivers Found !!
									// " + JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("rejectDriver Drivers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("approveAllDriver Drivers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("rejectAllDriver Drivers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("loadCustomerDetail Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
				...
				.fetchData(
						function(err, user) {
							if (!err) {
								if (user != null) {
									console
											.log("loadDriverDetail Customers Found !! "
													+ JSON.stringify(user));
									res.data = user;
									res.code = "200";
									callback(null, res);
